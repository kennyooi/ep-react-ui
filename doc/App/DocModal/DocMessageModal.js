				...
				<div className="group">
					<div className="grid-12 grid-p-sm-15">
						<div className="c-sm-4">
							<Button theme="blue" onClick={e => this.setState({ modal1: true })}>
								Info Message
							</Button>
						</div>
						<div className="c-sm-4">
						...
						<div className="c-sm-4">
							<Button theme="green" onClick={e => this.setState({ modal3: true })}>
								Success Message
							</Button>
						</div>
					</div>
	...
	generateModal(modalId, props) {
		return (
			<MessageModal 
				...
				onClose={e => this.setState({ [modalId]: false })}
			>
				<p>Modal message goes here...</p>
				{props.disableClose ? <p>Close is disabled, <a onClick={e => this.setState({ [modalId]: false })}>force close</a></p> : ''}
			</MessageModal>
		)
	}
}
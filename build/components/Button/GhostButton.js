...
var GhostButton = function (_Component) {
	_inherits(GhostButton, _Component);

	function GhostButton() {
		_classCallCheck(this, GhostButton);

		return _possibleConstructorReturn(this, (GhostButton.__proto__ || Object.getPrototypeOf(GhostButton)).apply(this, arguments));
	}

	_createClass(GhostButton, [{
		key: 'render',

    ...
    renderSample() {
        ...
        return (
            <div className="doc-form">
                ...
                <p>All form components are <strong>controlled components</strong> (<a href="https://facebook.github.io/react/docs/forms.html#controlled-components" target="_blank" rel="noopener noreferrer">source</a>). Input changes only when <code>value</code> prop is changed, else it won&amp;t work.</p>

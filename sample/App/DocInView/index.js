            ...
            <div className="page">
                <header className="page-title">
                    <div className="container">
                        ...
                        Component rely on <b>in-view.js</b> (<a href="https://github.com/camwiegert/in-view" target="_blank" rel="noopener noreferrer">https://github.com/camwiegert/in-view</a>).</p>
                    </div>
                </header>
